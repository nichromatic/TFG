...
public class ProceduralObjectNode
{
    ...
    public ProceduralObjectNode(ProceduralObjectNode parent, ObjectModelNode data, ProceduralObject PO)
    {
        parentNode = parent;
        parentObject = PO;
    ...
    private void LoadData(ObjectModelNode data)
    {
        rootNode = data.rootNode;
        nodeName = data.nodeName;
    }

    public void GenerateChildren(ObjectModelNode modelNode)
    {
